      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-300">
            ...
            <Link
              href="/pages/signup"
              className="mt-4 text-center block w-full black-btn"
            >
              Create Account
            </Link>

            <div className="mt-4 p-4 bg-gray-100 rounded-lg border border-gray-300 text-sm text-gray-600 text-center">
