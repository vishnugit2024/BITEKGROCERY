    ...
    return (
        <div className="bg-gray-50 text-gray-800 min-h-screen px-6 py-10 md:px-16 lg:px-32">
            <div className="max-w-5xl mx-auto bg-white rounded-2xl p-8 md:p-12">
                <h1 className="text-4xl font-bold text-purple mb-6">Privacy Policy</h1>
                <p className="mb-6 text-lg">
                    Welcome to <strong>Bitek Mart</strong>. We care about your privacy and are committed to safeguarding your personal information. This Privacy Policy outlines how we collect, use, and protect your data when you use our services.
                </p>

                {/* Section 1 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">1. What Information We Collect</h2>
                ...
                {/* Section 2 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">2. How We Use Your Data</h2>
                ...
                {/* Section 3 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">3. Data Sharing & Third Parties</h2>
                    <p className="mb-2">
                ...
                {/* Section 4 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">4. Cookies and Tracking Technologies</h2>
                    <p>
                ...
                {/* Section 5 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">5. Data Retention</h2>
                    <p>
                ...
                {/* Section 6 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">6. Your Rights</h2>
                    <ul className="list-disc list-inside space-y-1">
                    ...
                    <p className="mt-2">
                        Contact us at <a href="mailto:support@bitekmart.com" className="text-purple underline">support@bitekmart.com</a> for any privacy-related requests.
                    </p>
                </div>

                {/* Section 7 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">7. Security Measures</h2>
                    <p>
                ...
                {/* Section 8 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">8. Children's Privacy</h2>
                    <p>
                ...
                {/* Section 9 */}
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold text-purple mb-2">9. Policy Updates</h2>
                    <p>
