    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen px-4 py-8 md:px-16 lg:px-32">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl p-4 md:p-8">
        ...
        <p className="mb-6 text-lg">
          Welcome to <strong>Bitek Mart</strong>. We care about your privacy and
        ...
        <div className="mb-10">
          ...
          <p className="mb-2">
            ...
            partners for order fulfillment, analytics, and payment processing,
            such as:
          </p>
          <ul className="list-disc list-inside space-y-1">
        ...
        <div className="mb-10">
          ...
          <p>
            ...
            our services or as required by law. When no longer needed, your data
            is securely deleted.
          </p>
        </div>
        ...
        <div className="mb-10">
          ...
          <p>
            ...
            encryption, and secure third-party services to keep your data safe.
