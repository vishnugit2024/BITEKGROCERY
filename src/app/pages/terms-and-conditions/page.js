  ...
  return (
    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen px-6 py-10 md:px-16 lg:px-32">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl p-8 md:p-12">
        <h1 className="text-4xl font-bold text-purple mb-6">Terms & Conditions</h1>
        <p className="mb-6 text-lg">
          Welcome to <strong>Bitek Mart</strong>. These Terms & Conditions ("Terms") govern your access to and use of our website, services, and products. By using our platform, you agree to these Terms in full.
        </p>

        {/* Section 1 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">1. Use of Our Website</h2>
        ...
        {/* Section 2 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">2. Account & Security</h2>
          <p className="mb-2">You are responsible for maintaining the confidentiality of your account information.</p>
          <ul className="list-disc list-inside space-y-1">
        ...
        {/* Section 3 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">3. Orders & Payment</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        {/* Section 4 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">4. Delivery & Shipping</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        {/* Section 5 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">5. Returns & Refunds</h2>
          <p>
            Please refer to our{' '}
        ...
        {/* Section 6 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">6. Intellectual Property</h2>
          <p>
        ...
        {/* Section 7 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">7. Prohibited Activities</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        {/* Section 8 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">8. Termination</h2>
          <p>
        ...
        {/* Section 9 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">9. Limitation of Liability</h2>
          <p>
        ...
        {/* Section 10 */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">10. Changes to These Terms</h2>
          <p>
        ...
        {/* Contact Info */}
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-purple mb-2">11. Contact Us</h2>
          <p>
            For any questions regarding these Terms & Conditions, please email us at{' '}
            <a href="mailto:support@bitekmart.com" className="text-purple underline">
