                ...
                <div className="md:col-span-8">
                        ...
                        blogs.map((blog, index) => (
                            ...
                            <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-sm text-gray-500 mb-4">{blog.date} | Kitchen, themeWheel</p>
                    ...
                    <div className="flex justify-between mt-8">
                        ...
                        <button
                            ...
                            style={{backgroundColor: hasNextPage ? "var(--purple)" : "gray"
                            }}
                            className="text-white bg-purple hover:bg-purple/90 px-4 py-2 rounded-lg disabled:bg-gray-400"
                        >
                            Next
                ...
                <div className="md:col-span-4 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a href="#" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">
                                Facebook
                            </a>
                            <a href="#" className="bg-blue-400 hover:bg-blue-500 text-white px-4 py-2 rounded-lg">
                                Twitter
                            </a>
                            <a href="#" className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-lg">
                                Instagram
                            </a>
                            <a href="#" className="bg-blue-800 hover:bg-blue-900 text-white px-4 py-2 rounded-lg">
                                LinkedIn
                            </a>
                        </div>
                    </div>
