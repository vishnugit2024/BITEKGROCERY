      ...
      <header className="w-full">
        ...
        <div className="flex justify-between items-center px-4 py-2 border-b">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-600">
              ...
              <span className="text-orange-500 font-medium">7:00 to 23:00</span>
            </span>
          </div>
          <div className="flex items-center gap-4 text-sm text-gray-600">
            <span>
              English <LucideChevronDown className="inline ml-1 w-4 h-4" />
            </span>
            <span>
              USD <LucideChevronDown className="inline ml-1 w-4 h-4" />
            </span>
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            <div className="text-2xl font-bold text-purple-700">
              grogin<span className="text-sm">.com</span>
            </div>
            <div className="flex items-center text-gray-700 text-sm">
              <LucideMapPin className="w-4 h-4 mr-1" /> Deliver to{" "}
        ...
        <nav className="flex items-center px-4 border-t text-sm font-medium">
          <div className="px-4 py-3 border-r flex items-center gap-2 cursor-pointer">
            <LucideMenu className="w-5 h-5" /> All Categories{" "}
