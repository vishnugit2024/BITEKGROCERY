   ...
   const products = [
      {
         ...
         oldPrice: "150",
         newPrice: "100",
         description: "Premium long-grain basmati rice ideal for biryanis and everyday meals."
      },
      {
         id: 2,
         img: product2,
         ...
         oldPrice: "120",
         newPrice: "96",
         description: "High-quality white chickpeas perfect for curries and salads."
      },
      {
         id: 3,
         img: product3,
         ...
         oldPrice: "140",
         newPrice: "115",
         description: "Rich in protein and fiber, great for a healthy vegetarian diet."
      },
      {
         id: 4,
         img: product4,
      ...
      },
      {
         ...
         oldPrice: "140",
         newPrice: "115",
         description: "Wholesome and versatile pulses for a variety of Indian dishes."
      },
      {
         id: 6,
         img: product6,
      ...
      },
      {
         ...
         oldPrice: "110",
         newPrice: "99",
         description: "Split yellow moong dal, easy to cook and gentle on the stomach."
      },
      {
         id: 8,
         img: product2,
      ...
      },
      {
         ...
         oldPrice: "100",
         newPrice: "75",
         description: "Delicious and easy-to-cook pasta made from premium durum wheat."
      },
   ];
                  ...
                  >
                     ...
                     <div className="w-full">
                        <Link href={`/product/${product.id}`}>
                           <h3 style={{ background: "linear-gradient(90deg, rgb(212, 252, 121) 0%, rgb(150, 230, 161) 50%)", color: "#166534", maxWidth: 'fit-content', padding: '0px 10px', fontSize: '14px' }} className="mt-2 mb-2 text-md font-bold line-clamp-2 hover:underline rounded-l-0 rounded-r-2xl">
                              {product.name}
                           </h3>
                        </Link>
                        ...
                        <div className="flex items-baseline gap-2 mt-2">
                           <bdi className="text-2xl font-bold text-red-500">
                              ₹ {product.newPrice}
                           </bdi>
                           <bdi className="text-sm text-gray-800 font-bold line-through">
                              ₹ {product.oldPrice}
                           </bdi>
                        </div>
